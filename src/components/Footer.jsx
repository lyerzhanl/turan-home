const ContactSection = () => {
  return (
    <section className="py-12 flex items-center" style={{height: "120vh"}}>
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-[1fr_10px_1fr] gap-8" style={{maxWidth: "1320px"}}>
        ...
        <div className="md:w-[90%] px-4 mt-16 md:px-0 md:mt-0">
          ...
          <address className="not-italic mb-4">
            <p className="text-[17px] text-gray-700">г. Астана, Улица Кажымукан, 12а, Бизнес-центр Lasalle corporation</p>
            <p className="text-[17px] text-gray-700">+7 (707) 650-18-88</p>
            <p className="text-[17px] text-gray-700">turanhomeast@gmail.com</p>
          </address>
          {/* Соцсети */}
          <div className="flex gap-4 mb-4">
            <a href="#" className="w-8 h-8 bg-blue-600 flex items-center justify-center text-white">
              ВК
            </a>
        ...
        {/* Вертикальная линия */}
        <div className="hidden md:block bg-[#c59676] opacity-10" style={{width: "2px", height: "100%"}}></div>
